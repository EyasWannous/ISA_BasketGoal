...
internal class Phase26 : PhaseBase
{
    ...
    public Phase26()
    {
        ...
        BasketP = new(1, 2);
        BallP = new() { new(1, 1), new(1, 3) };
        Coin = null;
        Walls = new()
        {
            new(0, 0), new(0, 1), new(0, 3), new(0, 4),
            new(1, 0), new(1, 4), new(2, 2), new(3, 0),
            new(3, 4), new(4, 0), new(4, 1), new(4, 3),
            new(4, 4),
        };
